 ...
 * Magento
 * @category    DMS
 * @package     DMS_Sparkstoen
 * @copyright   dmaduranga@netstarter.com
 * @license     dmaduranga@netstarter.com
 */
 ...
 */
class DMS_Sparkstone_ProductImport extends Mage_Shell_Abstract
{
    /**
...
$shell = new DMS_Sparkstone_ProductImport();
$shell->run();
